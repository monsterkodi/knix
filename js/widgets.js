...
Console = (function(_super) {
  ...
  Console.prototype.logInfo = function(info, url, s) {
    ...
    this.insert('<pre class="' + styles + '">' + '<a onClick=\'' + url + '\' class="console-link" title="' + infoStr + ' ' + tags.join(' ') + '">' + '<span class="console-class">' + info["class"] + '</span>' + '<span class="console-method-type">' + info.type + '</span>' + '<span class="console-method">' + info.method + ' </span>' + '<span class="octicon octicon-playback-play"></span>' + '</a> ' + Console.toHtml(s) + '</pre>');
    return this.updateTags();
  };
